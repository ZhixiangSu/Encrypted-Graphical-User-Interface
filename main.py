...
class Body(tk.Frame):
    ...
    def set_text_entry(self, text:str):
        ...
        self.entry_editor.insert('end',text)
...
class MainApp(tk.Frame):
    ...
    def publish(self,post:Post):
        response=ds_client.send(self._current_profile.dsuserver,3021,self._current_profile.username,self._current_profile.password,post.get_entry())
        if response is True:
            self.footer.set_status("Success")
        else:
